...
public class Operations
{
	        ...
	        throws Exception
	{
		...
		try {
			...
			if(GENERIC_TESTSOL_XPATH_CONSTANTS.SWITCH_TO_MAIN_MENU.equals(sOperation)){
				switchToMainMenu(sOperation, menuEntityName, testCaseId, driver,daoObject,arrdata);				
			}else{
	...
	private static void switchToMainMenu(String sOperation, String menuEntityName, String testCaseId, WebDriver driver,
			InputOutputDaoObject daoObject, ArrayList<String> arrdata) {
